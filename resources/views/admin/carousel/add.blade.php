...
<ul class="nav nav-pills nav-stacked custom-nav">
    ...
    <li class="menu-list nav-active"><a href=""><i class="fa fa-picture-o"></i> <span>轮播管理</span></a>
        <ul class="sub-menu-list">
            <li><a class="menuchild" href="/admin/carousel">轮播列表</a></li>
            <li class="active"><a class="menuchild" href="/admin/carousel/create">轮播添加</a></li>
        </ul>
    </li>
    ...
    <div class="col-lg-12">
        <section class="panel">
            ...
            <div class="panel-body">
                ...
                @endif
                <form role="form" action="/admin/carousel" method="post" class="form-horizontal adminex-form"  enctype="multipart/form-data" style="margin-top:20px">
                    {{csrf_field()}}

                    <div class="form-group has-success">
                        <label class="col-lg-3 control-label">组号</label>
                        <div class="col-lg-6 input-group-lg">
                            <input type="text" name="lid" id="l-name" class="form-control">
                        </div>
                    </div>    
