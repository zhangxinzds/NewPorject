...
<ul class="nav nav-pills nav-stacked custom-nav">
    ...
    <li class="menu-list nav-active"><a href=""><i class="fa fa-laptop"></i> <span>友链管理</span></a>
        <ul class="sub-menu-list">
            <li><a href="/admin/link">友链列表</a></li>
            <li class="active"><a href="/admin/link/create">友链添加</a></li>
        </ul>
    </li>
</ul>
@stop
...
<div class="page-heading">
    ...
    <ul class="breadcrumb">
        <li>
            <a href="/admin/goods">友链管理</a>
        </li>
        <li class="active">友链添加</li>
    </ul>
</div>
@stop
