          ...
          <div id="navbarCollapse" class="collapse navbar-collapse">
            ...
            <div class="d-flex align-items-center justify-content-between justify-content-lg-end mt-1 mb-2 my-lg-0">
              ...
              <div aria-labelledby="userdetails" class="dropdown-menu dropdown-menu-right"> 
                <a href="customer-orders.html" class="dropdown-item">Orders</a>
                <a href="customer-addresses.html" class="dropdown-item">Addresses</a>
                <a href="customer-account.html" class="dropdown-item">Profile</a>
                <div class="dropdown-divider my-0"></div>
                <a href="/home/logout" class="dropdown-item">Logout</a>
                </div>
              </div>
              @else
              <div class="nav-item">
